...
export const metadata: Metadata = {
 ...
 keywords: [
  ...
  "Bhagalpur distance education",
  "Purnia distance education",
  "Katihar distance education",
  "Madhepura distance education",
  "Begusarai distance education",
  ...
  // Maharashtra
  "Mumbai distance education",
  "Mumbai online education",
  "Mumbai college admission",
  "Pune distance education",
  "Pune online education",
  "Pune college admission",
  "Navi Mumbai distance education",

  // Karnataka
  "Bangalore distance education",
  "Bangalore online education",
  "Bangalore college admission",

  // Delhi NCR
  "Delhi distance education",
  "Delhi online education",
  "Delhi college admission",
  "Gurgaon distance education",
  "Gurgaon online education",
  "Gurgaon college admission",
  "Ghaziabad distance education",
  "Faridabad distance education",

  // Jharkhand
  "Ranchi distance education",
  "Ranchi online education",
  "Ranchi college admission",

  // West Bengal
  "Kolkata distance education",
  "Kolkata online education",
  "Kolkata college admission",

  // Madhya Pradesh
  "Bhopal distance education",
  "Bhopal online education",
  "Bhopal college admission",
  "Rewa distance education",
  "Rewa college admission",
  "Gwalior distance education",
  "Gwalior college admission",
],
