    ...
    <div className="min-h-screen flex items-center justify-center bg-[#FDFBF7] px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <a
          ...
          className="group mt-5 flex flex-wrap items-center justify-center gap-1.5"
        >
          <span className="text-[0.72rem] text-[#9CA3AF]">Design and developed with</span>
          <span className="animate-pulse text-[0.8rem]" style={{ color: "#e0507a" }}>
            ❤
          </span>
          ...
          />
          <span className="text-[0.72rem] font-semibold text-[#8a6d31]">Arun Dev Studio</span>
        </a>
      </div>
    </div>
  );
