...
export async function GET(req: NextRequest) {
  ...
  return NextResponse.json(
    courses.map((c) => ({
      ...
      yearlyFee: c.yearlyFee ? c.yearlyFee.toString() : null,
      status: c.status,
...
export async function POST(req: NextRequest) {
  ...
  const created = await prisma.course.create({
    data: {
      ...
      yearlyFee: body.yearlyFee ? String(body.yearlyFee) : null,
  ...
  return NextResponse.json(
    {
      ...
      yearlyFee: created.yearlyFee ? created.yearlyFee.toString() : null,
